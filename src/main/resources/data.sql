...
-- Insertion des données dans la table type_de_vin
INSERT INTO type_de_vin (id, nom, couleur, millesime, teneur_alcool, duree_garde, temperature_service, description, region_viticole, prix_moyen, volume_production, cepage_principal_id, domaine_origine_id) VALUES 
(1, 'Margaux', 'Rouge', 2015, 13.5, 20, 16.0, 'Un vin exceptionnel et connu provenant de Bordeaux', 'Bordeaux', 250.0, 200000.0, 1, 1),
(2, 'Romanée-Conti', 'Rouge', 2014, 14.0, 25, 16.0, 'Un vin faisant partie du terroir et de la culture bourguignonne', 'Bourgogne', 12000.0, 120000.0, 2, 2),
(3, 'Chardonnay Grand Cru', 'Blanc', 2017, 13.5, 15, 12.0, 'Un grand cru de Bourgogne', 'Bourgogne', 500.0, 50000.0, 2, 4),
(4, 'Pomerol', 'Rouge', 2016, 14.5, 20, 16.0, 'Un vin prestigieux de Pomerol', 'Pomerol', 600.0, 70000.0, 10, 9),
(5, 'Sauternes', 'Blanc', 2018, 12.0, 30, 10.0, 'Un vin doux de Sauternes', 'Sauternes', 300.0, 80000.0, 7, 3),
(6, 'Riesling Grand Cru', 'Blanc', 2019, 12.5, 25, 10.0, 'Un riesling exceptionnel d’Alsace', 'Alsace', 250.0, 70000.0, 8, 6),
(7, 'Syrah de Rhône', 'Rouge', 2015, 14.0, 18, 16.0, 'Un syrah typique du Rhône', 'Rhône', 150.0, 50000.0, 6, 4),
(8, 'Grenache du Sud', 'Rouge', 2017, 13.8, 20, 15.0, 'Un grenache du sud de la France', 'Sud', 100.0, 55000.0, 7, 10),
(9, 'Pinot Noir', 'Rouge', 2016, 13.0, 15, 14.0, 'Un pinot noir délicat', 'Bourgogne', 180.0, 60000.0, 5, 5),
(10, 'Tempranillo Reserva', 'Rouge', 2018, 14.2, 22, 16.0, 'Un tempranillo vieilli en fût', 'Espagne', 220.0, 70000.0, 10, 10);

-- Insertion des données dans la table appelation
INSERT INTO appelation (id, nom_appelation, annee_creation, lieu) VALUES 
...
-- Insertion des données dans la table cepage
INSERT INTO cepage (id, nom, couleur, caracteristiques_gustatives, region_origine, taux_sucre, acidite, potentiel_garde, rendement, temperature_optimale, resistance_maladies, aromes_typiques, alcool_potentiel, descriptif) VALUES 
...
-- Insertion des données dans la table domaine_exploitation
INSERT INTO domaine_exploitation (id, nom, region, superficie, date_de_creation, proprietaire, type_production, volume_production_annuel, description, contact, site_web) VALUES 
...
-- Insertion des données dans la table vin
